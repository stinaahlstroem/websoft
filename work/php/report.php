...
<header>
<h1>Reportpage from the course DA377B VT20 Software Development for the Web</h1>
</header>
...
<h2>S10</h2>
<p><b>Write a general paragraph about how the project was implemented. Problems / solutions / simple /</p>
...
<p><b>Implementing techniques:</b></p>
          ...
          <p>Style: Bootstrap styling library</p>
          <p>Icons: Font awesome</p>
          <p>jQuery: used to add click functionality and do AJAX calls to rerender the products</p>
          <p>JavaScript HTML CSS in between</p>
          <p>Version control: Git</p>
          <p>Pictures from: unsplash.com</p>
<br>
<p>I did the project by myself and I think I worked out pretty well. I searched for information</p>
<p>when I got stuck. I started the project right after the assignments. I have never worked with JavaScript</p>
<p>before so it was quite difficult at the beginning but I learned a lot from the assignment so</p>
<p>the project went on great. I think it was good to do the assignments first and then start with the</p>
<p>project since we got a lot of information during the lectures and how to solve them which then could</p>
